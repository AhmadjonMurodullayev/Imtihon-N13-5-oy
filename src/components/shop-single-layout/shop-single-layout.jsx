    ...
    <Stack>
      ...
      <Container maxWidth="Sm">
        ...
        >
          ...
          <Stack sx={{ flex: 1, maxWidth: "50%" }}>
            <Typography variant="h6" fontWeight={700} fontSize={40}>
            Health Pistachios
            </Typography>
            <Rating name="size-small" defaultValue={5} size="small" />
            <Stack direction={"row"} alignItems={"center"} gap={2}>
              <Typography variant="h5" fontWeight={700} color={"#B8B8B8"} fontSize={"20px"}>
                {item.price}
              </Typography>
              <Typography variant="h6" fontWeight={700} fontSize={"25px"}>
                {item.price2}
              </Typography>
            </Stack>
      ...
      <Container maxWidth="Sm">
        ...
        >
          ...
          <Typography>
            Welcome to the world of natural and organic. Here you can discover the bounty of nature. We aim to give our customers a healthy chemical-free meal for perfect nutrition. It offers about 8–10% carbs. Simple sugars make up 70% and 80% of the carbs in raw.
          </Typography>
        </Stack>
      </Container>

      <Container maxWidth="Sm">
        <Typography textAlign={"center"} variant="h6" fontSize={"50px"} my={4}>
          Related Products
        </Typography>
                ...
                >
                  ...
                  <Stack direction="row" justifyContent="space-between">
                    <Stack direction="row" spacing={1}>
                      <Typography variant="body2" color="primary" sx={{ textDecoration: "line-through" }}>
                        {item.price}
                      </Typography>
